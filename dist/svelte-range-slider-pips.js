...
(function (global, factory) {
    ...
    // (204:2) {#if ( all && first !== false ) || first }
    function create_if_block_8(ctx) {
    	let span;
    	let span_style_value;
    	let mounted;
    	let dispose;
    	let if_block = (/*all*/ ctx[6] === 'label' || /*first*/ ctx[7] === 'label') && create_if_block_9(ctx);
    ...
    // (213:6) {#if all === 'label' || first === 'label'}
    function create_if_block_9(ctx) {
    	let span;
    	let t_value = /*formatter*/ ctx[12](/*fixFloat*/ ctx[16](/*min*/ ctx[0]), 0, 0) + "";
    	let t;
    	let if_block = /*prefix*/ ctx[10] && create_if_block_10(ctx);
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty[0] & /*orientationStart, percentOf, pipVal, isSelected, inRange, labelDown, labelUp, formatter, prefix, all, rest, min, max, pipCount*/ 8312387) {
    ...
    // (223:6) {#if pipVal(i) !== min && pipVal(i) !== max}
    ...
    // (222:4) {#each Array(pipCount + 1) as _, i}
    ...
    function create_fragment(ctx) {
    	...
    	let t0;
    	let t1;
    	let if_block0 = (/*all*/ ctx[6] && /*first*/ ctx[7] !== false || /*first*/ ctx[7]) && create_if_block_8(ctx);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	let t;
    	let if_block = /*prefix*/ ctx[18] && create_if_block_3$1(ctx);
